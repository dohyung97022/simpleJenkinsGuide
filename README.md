...
## 아이템 생성
  ...
  * 빌드 후 조치 추가   
    ...
    <br>
    `2> /dev/null` 의 이유는 nohup 이후에 enter 를 칠 필요가 없게 만들기 위해서입니다.   
    build 를 할 때 문제는 없지만, warning 이 나옵니다.   
    <br>
    이제 마지막으로 저장하시고...   
    ...
    눌러보셔서 console Output 을 확인하실 수 있습니다.   